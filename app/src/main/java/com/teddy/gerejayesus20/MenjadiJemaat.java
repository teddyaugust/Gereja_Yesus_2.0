...
public class MenjadiJemaat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menjadi_jemaat);

        //buka webnya
        webView = (WebView) findViewById(R.id.menjadi_jemaat_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://gereja.yuk-simak.info/cara-menjadi-anggota-jemaat/");
