...
public class WartaJemaat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //buka webnya
        webView = (WebView) findViewById(R.id.warta_jemaat_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://gereja.yuk-simak.info/category/warta/warta-2021/");
