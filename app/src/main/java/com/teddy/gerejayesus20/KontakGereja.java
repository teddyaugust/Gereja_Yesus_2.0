...
public class KontakGereja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kontak_gereja);

        //buka webnya
        webView = (WebView) findViewById(R.id.kontak_gereja_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://gereja.yuk-simak.info/layanan-gereja/");
