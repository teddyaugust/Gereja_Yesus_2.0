...
public class ChatBotWA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_bot_wa);

        //buka webnya
        webView = (WebView) findViewById(R.id.chatbot_wa_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://gereja.yuk-simak.info/chat-bot-wa/");
